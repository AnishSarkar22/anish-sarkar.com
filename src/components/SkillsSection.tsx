...
// Component showing optimized skill level
  ...
  return (
    <div className="flex space-x-1.5">
      {levels.map((filled, i) => (
        ...
        >
          {/* Gradient effect inside level bar */}
          {filled && isHovered && (
            <motion.div
...
export default function SkillsSection() {
  ...
  // Mouse position tracking for space cursor effect
  useEffect(() => {
