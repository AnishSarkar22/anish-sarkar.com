    ...
    <TransitionWrapper>
      <div className="container mx-auto flex min-h-screen flex-col items-center justify-center px-4 py-16 text-center">
        <div className="relative">
          ...
          <div className="-inset-10 absolute animate-pulse rounded-full bg-gradient-radial from-green-300/10 to-transparent opacity-30 blur-3xl" style={{ animationDuration: '4s' }} />
          
          <h1 className="relative mb-6 inline-block font-bold text-5xl text-white">
            404 - Blog Not Found
            <div className="-bottom-2 absolute left-0 h-[3px] w-full animate-pulse bg-gradient-to-r from-green-300/0 via-green-300 to-green-300/0" style={{ animationDuration: '3s' }} />
          </h1>
